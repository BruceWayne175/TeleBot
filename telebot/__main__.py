...
async def startup_log_all_done():
    try:
        await bot.send_message(TELE, f"**Bruce's Bot has been deployed.\nSend** `{CMD_HNDLR}alive` **to see if the bot is working.\n\nAdd** @{BOTNAME} **to this group and make it admin for enabling all the features of Bruce's Bot**")
...
print("Bruce's Bot has been deployed! ")
...
print("TeleBot has been fully deployed! Do Visit @BruceSL")
