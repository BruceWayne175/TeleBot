...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            help_string = f"""`Userbot Helper for {DEFAULTUSER} to reveal all the commands of `**[Bruce's Bot](https://github.com/BruceWayne175/TeleBot)**\n\n"""
            try:
