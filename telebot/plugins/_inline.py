...
TELEPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/ecae25dbf7f5254023a00.png"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
MESAG = (
    str(CUSTOM_PMPERMIT)
    if CUSTOM_PMPERMIT
    else "`@BruceSL's PM security! Please wait for me to approve you.😜🤟"
)
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "@BruceSL"
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
        ...
        if event.query.user_id == bot.uid and query.startswith("`Userbot"):
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [
                        custom.Button.url(
                            "📊Updates and Support Group↗️", "https://t.me/ehifilesl"
                        )
                    ],
                ],
                link_preview=False,
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = (
                "Please get your own Userbot from @BruceSL , and don't use mine😒"
            )
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "Please get your own userbot from @BruceSL 😒"
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
